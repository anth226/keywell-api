/**
 * Class validator for automatically validate from args of query/mutation
 * Working in progress
 */
import { UserInputError } from 'apollo-server';
import { IsDate, IsDefined, IsEnum, IsObject, IsOptional, IsString, Length, validateSync } from 'class-validator';
import { uniq } from 'lodash';
import { ChildMedicationMutationsAddArgs, ChildMedicationInput, MedicationInput, DayOfWeek } from '../../../../types/schema.types'
